		...
		<div class="comment-text ui--box ui--gradient ui--gradient-grey clearfix">
			...
			<div class="meta ui--gradient ui--gradient-grey ui--gradient-grey-border-bottom clearfix">
				...
				<div class="pull-left">
					...
					<?php else : ?>
							<strong itemprop="author"><?php comment_author_link( get_comment_ID() ); ?></strong> <span class="dash">&ndash;</span> <small><time itemprop="datePublished" datetime="<?php echo get_comment_date('c'); ?>"><?php echo get_comment_date(__( get_option('date_format'), 'cloudfw' )); ?></time>:</small>
